...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'mybot_description' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/raaslab/Desktop/AddSensor/mybot_ws/install/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/raaslab/Desktop/AddSensor/mybot_ws/install/lib;/home/raaslab/MACE/OpenMACE/catkin_sim_environment/devel/lib;/opt/ros/kinetic/lib)
